...
<div style="background: url(https://www.openathens.net/app/uploads/2021/08/alfons-morales-YLSwjSy7stw-unsplash.jpg)" class="page-holder bg-cover">
	<div class="h-100 row align-items-center">
		...
		<div class="col-sm-4 bg-dark text-white border border-light rounded border-2 px-2 py-2" align="center">
			<h1><small>Potvrdite svoj email i lozinku:</small></h1><br/>
			<form class="needs-validation" action="deletus.php" method="post" novalidate>
			...
			<div class="row pb-2" align="center">
				<div class="col-sm-2"></div>
				<div class="col-sm-8">
					<button class="btn btn-success btn-block btn-sm border border-light rounded border-2" type="submit" name="submit"><h4><small>Ok</small></h4></button>
				</div>
				<div class="col-sm-2"></div>
			</div>
			</form>
